...
def validate_radiology_therapy_correctness(entry: dict, birth_date: str = None) -> dict:
    try:
        result = {
            ...
            "therapy_start_date": validate_therapy_start_date_field(entry, birth_date).get("therapy_start_date"),
        ...
        print(f"[ERROR] RadiologyTherapy correctness validation failed: {e}")
